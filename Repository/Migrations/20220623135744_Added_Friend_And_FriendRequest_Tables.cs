...
{
    public partial class Added_Friend_And_FriendRequest_Tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friend", x => new { x.UserId, x.Photo });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendRequests", x => new { x.UserId, x.FromId });
                    table.ForeignKey(
